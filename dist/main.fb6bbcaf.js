...
var vh = Math.max(document.documentElement.clientHeight || 0, window.innerHeight || 0); // side-nav

var anchorHeader = document.querySelector("#anchor-header");
var anchorProjets = document.querySelector("#anchor-projets");
var anchorAPropos = document.querySelector("#anchor-a-propos");
var anchorContact = document.querySelector("#anchor-contact");
...
landingNumProject1.addEventListener("mouseleave", function () {
  landingTextProject1.classList.remove("active");
});
landingNumProject2.addEventListener("mouseenter", function () {
  landingTextProject2.classList.add("active");
});
landingNumProject2.addEventListener("mouseleave", function () {
  landingTextProject2.classList.remove("active");
});
landingNumProject3.addEventListener("mouseenter", function () {
  landingTextProject3.classList.add("active");
});
landingNumProject3.addEventListener("mouseleave", function () {
  landingTextProject3.classList.remove("active");
});
landingNumProject4.addEventListener("mouseenter", function () {
